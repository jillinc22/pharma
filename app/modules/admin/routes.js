...
router.use('/colleges/:int_itemStockID/edit', require('./colleges/routes'));
router.use('/colleges/:int_itemStockID/edit/updatemed', require('./colleges/routes'));
...
router.use('/petition/:int_petitID/editpetit', require('./petition/routes'));
